...
$$\text{subject to } \ g_i(\mathbf{w}) \le 0 \quad \text{for } i=1,\ldots,k,$$  
$$\qquad\qquad\ \ h_i(\mathbf{w}) = 0 \quad \text{for } i=1,\ldots,l$$
...
$$\min_{\mathbf{w},b}\ \frac{1}{2}|\mathbf{w}|^2 + C\sum_{i=1}^{n}\xi_i$$  $$\text{subject to}\quad y_i(\mathbf{w}^T\mathbf{x}_i+b)\ge 1-\xi_i,\quad i=1,\ldots,n$$  $$\xi_i\ge 0,\quad i=1,\ldots,n$$
